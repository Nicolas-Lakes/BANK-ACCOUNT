...
class TELLER(BANK):
    def __init__(self):
        ...
        self.Id = 'Identifier'
        self.CustomerAccountNos = BanksDataBase.CentenaryCustomerAccountNos
        self.CustomerNames = BanksDataBase.CentenaryCustomerNames
        self.CustomerIds = BanksDataBase.CentenaryCustomerIds
        self.CustomerAddresses = BanksDataBase.CentenaryCustomerAddresses
        self.Balances = BanksDataBase.CentenaryCustomerBalance
        self.CustomerPhoneNos = BanksDataBase.CentenaryCustomerPhoneNos
        self.CustomerLoansRecords = BanksDataBase.CentenaryLoansRecords
        self.TellerIds = BanksDataBase.CentenaryTellerIds
        self.TellerNames = BanksDataBase.CentenaryTellerNames
    ...
    def LoanRequest(self):
        ...
        if self.Amount >= 20*int(self.Balance) or self.Amount <= 1.5*int(self.Balance):
            ...
            f = open("BANKS\CentenaryBankFiles\LoansRecords.txt", 'w')
